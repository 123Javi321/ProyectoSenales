...
class ventanaAudios:
    def __init__(self):
        ...
        ventanaAudios.botonA1 = Button(ventanaAudios, text="Primer audio",
                                       command=lambda: [pygame.mixer.music.load(m1), pygame.mixer.music.play(loops=0),
                                                        self.A1()], width=20)
        ventanaAudios.botonA1.place(x=30, y=60)
        # Load y play del segundo audio
        ventanaAudios.botonA2 = Button(ventanaAudios, text="Segundo audio",
                                       command=lambda: [pygame.mixer.music.load(m2), pygame.mixer.music.play(loops=0),
                                                        self.A2()], width=20)
        ventanaAudios.botonA2.place(x=230, y=60)
        # Load y play del tercer audio
        ventanaAudios.botonA3 = Button(ventanaAudios, text="Tercer audio",
                                       command=lambda: [pygame.mixer.music.load(m3), pygame.mixer.music.play(loops=0),
                                                        self.A3()], width=20)
...
class ventanaImportar:
    def __init__(self):
        ...
        ventanaImportar.botonImportar = Button(ventanaImportar, text="Importar",
                                               command=lambda: [self.importar(), ventanaImportar.destroy()], width=20)
