...
# prueba1
# cd onedrive/escritorio/proyectosenalesg1
import os
from tkinter import *
...
class ventanaAudios:
    def __init__(self):
        ...
        pauseImg = PhotoImage("pause.png")
        playImg = PhotoImage("play.png")
        # Load y play del primer audio
        ventanaAudios.botonA1 = Button(ventanaAudios, text="Primer audio", image=playImg, command=lambda: [self.A1()], height=40, width=40)
        ...
        ventanaAudios.botonStop = Button(ventanaAudios, text="Pausa", image=pauseImg, command=self.St, width=20)
...
class ventanaImportar:
    def __init__(self):
        ...
        imgImport=PhotoImage(file="Importar.png")
        ...
        ventanaImportar.botonImportar = Button(ventanaImportar, image=imgImport,
